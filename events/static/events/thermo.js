...
var Thermometer = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Thermometer, [{
    ...
    value: function render() {
      var theme = "thermometer--theme-".concat(this.state.theme());
      var size = "thermometer--".concat(this.state.size());
      var height = {
      ...
      var heightBgColor = {
        height: "calc(".concat(this.state.height, "px - 57px)")
      };
      ...
      }, stepIntervals), /*#__PURE__*/React.createElement("div", {
        style: heightPercent,
